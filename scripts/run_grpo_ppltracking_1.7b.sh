...
# Run GRPO with PPL tracking during validation - Qwen3-1.7B version
# Adjusted parameters for smaller model
...
MODEL_PATH="/home/qian.niu/Takoai/Medical_Reasoning/Mark/rldynamics/models/Qwen3-1.7B"
...
python3 -m custom_training.ppo_trainer_ppl \
    ...
    trainer.experiment_name='qwen3_1.7b_math500_ppl' \
